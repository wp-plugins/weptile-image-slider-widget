...
The slider settings are all done within the widget. There are 16 different animation options, 16 widget options and 4 built in slider templates.
...
3. Add your slider widgets from the 'Widgets' screen.
